...
\input{secciones_plan_accion/01-simulaciones-n-cuerpos-y-comparaciones}
\input{secciones_plan_accion/02-animaciones-y-visualizaciones}
\input{secciones_plan_accion/03-elementos-orbitales-y-constantes}
\input{secciones_plan_accion/04-hodografo-de-apophis}
\input{secciones_plan_accion/05-ecuacion-de-kepler-y-propagacion}
\input{secciones_plan_accion/06-geometria-orbital-3d}
\input{secciones_plan_accion/07-patched-conics}
\input{secciones_plan_accion/08-estadistica-y-analisis-de-incertidumbre}
\input{secciones_plan_accion/09-ideas-extras-creativas}
\input{secciones_plan_accion/10-que-pasaria-si}

\begin{center}
\begin{tcolorbox}[width=0.55\textwidth,colback=white,colframe=black!50,boxrule=0.4pt,arc=2pt]
\centering\textit{En construcción...}
\end{tcolorbox}
\end{center}
