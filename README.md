...
El proyecto se presenta en tres formatos complementarios, disponibles en el actual repositorio. Se recomienda revisarlos en este orden:
...
2. **Informe (LaTeX / PDF)** — Documento completo con el marco teórico, la metodología y el análisis de resultados. Aquí están las ecuaciones, las tablas de parámetros y la discusión detallada. Leer después del video para profundizar en la formulación matemática y las decisiones metodológicas.
