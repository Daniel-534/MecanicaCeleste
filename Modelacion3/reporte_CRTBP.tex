...
\medskip
\noindent\textbf{Palabras clave:} CRTBP, misión Lucy, asteroides troyanos, Júpiter, constante de Jacobi, regiones de exclusión, captura balística, punto de Lagrange \(L_1\), JPL Horizons.
\end{abstract}
...
\noindent\textit{Nota:} es posible ver la animación completa del proceso de captura y escape en el repositorio de GitHub del proyecto (enlace disponible al inicio del notebook asociado a este reporte).
