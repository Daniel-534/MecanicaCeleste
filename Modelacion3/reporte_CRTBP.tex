...
\subsection{Aproximación de Euler para el punto \(L_1\)}
...
\subsection{Experimento exploratorio de captura balística cerca de \(L_1\)}
...
\subsection{Experimento exploratorio: captura balística temporal cerca de \(L_1\)}
\label{sec:captura}
